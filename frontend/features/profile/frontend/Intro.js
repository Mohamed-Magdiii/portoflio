    ...
    <section className="grid items-center gap-12 py-16 md:grid-cols-2 lg:py-24">
      ...
      <div className="relative mx-auto">
        <div className="animate-float">
          <div className="rounded-full bg-gradient-to-br from-red-200 via-red-400 to-red-600 p-2 shadow-2xl shadow-indigo-400/40 ring-2 ring-indigo-300/50">
            <div className="relative h-56 w-56 overflow-hidden rounded-full bg-white p-1 md:h-80 md:w-80 lg:h-96 lg:w-96">
              <Image
